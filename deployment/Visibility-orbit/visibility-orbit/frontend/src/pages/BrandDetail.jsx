    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="flex gap-3">
          <Link to={`/brands/${brandId}/probes`}    className="btn-primary">▶ Run probes</Link>
          <Link to={`/brands/${brandId}/alerts`}    className="btn-secondary">🚨 Alerts {stats?.unresolved_alerts > 0 && `(${stats.unresolved_alerts})`}</Link>
          <Link to={`/brands/${brandId}/knowledge`} className="btn-secondary">🧠 Facts</Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to={`/brands/${brandId}/alerts`} className="text-xs text-indigo-400 hover:text-indigo-300">View all →</Link>
          </div>
          {alerts.length === 0 ? (
      ...
      <div className="card mt-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to={`/brands/${brandId}/probes`} className="text-xs text-indigo-400 hover:text-indigo-300">View all →</Link>
        </div>
        {runs.length === 0 ? (
